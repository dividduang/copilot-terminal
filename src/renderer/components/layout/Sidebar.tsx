      ...
      <aside className="w-64 h-screen bg-zinc-950 border-r border-zinc-800 flex flex-col">
        ...
        <div className="flex-1 px-4 py-4 overflow-y-auto">
          <button
            ...
            className="w-full flex items-center gap-3 px-4 py-3 rounded-lg bg-blue-600 hover:bg-blue-500 text-white font-medium transition-all duration-200 shadow-lg shadow-blue-600/20 hover:shadow-blue-500/30 hover:scale-[1.02] active:scale-[0.98]"
          >
            <Plus size={18} />
            <span>新建终端</span>
          </button>
          ...
          {/* 窗口数量提示 */}
          {windows.length > 0 && (
            <div className="mt-4 px-4 py-2 rounded-lg bg-zinc-900 border border-zinc-800">
